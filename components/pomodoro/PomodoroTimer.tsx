        ...
        <div className="fixed bottom-24 right-6 z-50 w-80 bg-white rounded-2xl shadow-2xl border border-gray-100 overflow-hidden">
          ...
          <div className="p-4 space-y-4">
            ...
            <input
              ...
              disabled={running}
              className="w-full text-sm border border-gray-200 rounded-xl px-3 py-2 focus:outline-none focus:border-orange-300 disabled:bg-gray-50 disabled:text-gray-400"
            />
            ...
            <div className="flex flex-col items-center gap-3">
              <div className="relative w-32 h-32">
                <svg className="w-32 h-32 -rotate-90" viewBox="0 0 128 128">
                  ...
                  <circle
                    cx="64" cy="64" r="56"
                    fill="none"
                    stroke={running ? "#f97316" : justCompleted ? "#10b981" : "#fb923c"}
                    strokeWidth="8"
                    strokeLinecap="round"
              ...
              {justCompleted && (
                <p className="text-sm font-semibold text-emerald-600 text-center">
                  🎉 Session terminée ! +{durationMin} min de focus
                </p>
              )}
            ...
            {sessions.length > 0 && (
              <div className="border-t border-gray-100 pt-3 space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-xs text-orange-600 font-semibold">{totalFocusMin} min focus</span>
                </div>
